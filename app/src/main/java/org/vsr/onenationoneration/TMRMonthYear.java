...
public class TMRMonthYear extends AppCompatActivity {
    ...
    private List<TMRData> tmrDataList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tmr_monthyear);
...
//below two lines for setting default year in spinner
        ...
        Toast.makeText(TMRMonthYear.this, monthgot, Toast.LENGTH_LONG).show();
    ...
    private void populatRecyclerView() {
        pd = new ProgressDialog(TMRMonthYear.this);
        ...
        tmrDataCall.enqueue(new Callback<TMRData>() {
            ...
            public void onResponse(Call<TMRData> call, Response<TMRData> response) {
                ...
                String strStatus = String.valueOf(response.body().getTmrReceivedDetailsList());
                if (strStatus.equalsIgnoreCase("null") || strStatus.equals(null)) {
                    Toast.makeText(TMRMonthYear.this, "Track My Ration Not Found", Toast.LENGTH_LONG).show();
                } else {
                    Intent intent = new Intent(TMRMonthYear.this, TrackMyRationActivity.class);
                    ...
                    Toast.makeText(TMRMonthYear.this, strMonth + "/" + strYear, Toast.LENGTH_LONG).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                return true;
            case R.id.item_home:
                Intent intent = new Intent(TMRMonthYear.this, HomeActivity.class);
                Bundle bundle = new Bundle();
                bundle.putString("TXNID", savedTXNIDFromRegActivity);
                intent.putExtras(bundle);
                startActivity(intent);
            ...
            case R.id.item_language:
                Intent intent2 = new Intent(TMRMonthYear.this, MainActivity.class);
